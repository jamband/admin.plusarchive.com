        ...
        <?php foreach ($data->models as $model): ?>
            <div class="col-md-6 col-lg-4 mb-sm-4">
                <div class="card">
                    <div class="card-img-wrap">
                        <div class="ratio <?= preg_match('/\A(Bandcamp|SoundCloud)\z/', $model->providerText) ? 'ratio-1x1' : 'ratio-16x9' ?>">
                            <?= Html::tag('img', '', [
                                ...
                                'alt' => '',
                                'loading' => 'lazy',
                                'data-action' => Url::toRoute('/tracks/now'),
                    ...
                    <div class="card-body">
                        <h6 class="card-title">
                            <a class="text-light" href="<?= Url::to(['/tracks/view/index', 'id' => Yii::$app->hashids->encode($model->id)]) ?>" data-pjax="0">
                        ...
                        <div class="card-text">
                            ...
                            <?php endforeach ?>
                            <p class="mt-1">
                                <a class="tag" href="<?= Url::to(['/tracks/update/index', 'id' => $model->id]) ?>" data-pjax="0">
                                    <i class="fas fa-fw fa-sm fa-edit"></i> Update
                                </a>
                                <a class="tag" href="<?= Url::to(['/tracks/delete/index', 'id' => $model->id]) ?>" data-confirm="Are you sure?" data-method="post">
