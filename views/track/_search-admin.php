        ...
        <div class="card-body">
            ...
            <div class="d-inline-block dropdown">
                <a id="search-provider" class="tag" href="#" data-bs-toggle="dropdown">
                    <?= Html::encode($provider) ?> <i class="fas fa-fw fa-sm fa-angle-down"></i>
                </a>
                <div class="dropdown-menu">
            ...
            <div class="d-inline-block dropdown">
                <a id="search-genre" class="tag" href="#" data-bs-toggle="dropdown">
                    <?= Html::encode($genre) ?> <i class="fas fa-fw fa-sm fa-angle-down"></i>
                </a>
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?= Url::currentPlus(['genre' => null, 'search' => null]) ?>">Reset</a>
                    <div class="dropdown-divider"></div>
                    <?php foreach (MusicGenre::getNames() as $name): ?>
                        <a class="dropdown-item" href="<?= Url::currentPlus(['genre' => $name, 'search' => null]) ?>"><?= Html::encode($name) ?></a>
                    <?php endforeach ?>
                </div>
            </div>
